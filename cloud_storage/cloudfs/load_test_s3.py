...
class UploadLargeFileUser5(XmlRpcUser):
...
class UploadLargeFileUser6(XmlRpcUser):
...
class UploadSmallFileUser5(XmlRpcUser):
...
class UploadSmallFileUser6(XmlRpcUser):
...
class DownloadLargeFileUser5(XmlRpcUser):
...
class DownloadLargeFileUser6(XmlRpcUser):
...
class DownloadSmallFileUser5(XmlRpcUser):
...
class DownloadSmallFileUser6(XmlRpcUser):
